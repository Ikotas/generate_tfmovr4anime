...
static void print_usage() {
    ...
    cout << "--------------------------------------" << endl;
    cout << "Usage: generate_tfmovr4anime.exe [options] TFM_output_file(*.tfm)" << endl << endl;
    cout << "Options:" << endl;
...
int main(int argc, char* argv[]) {
    ...
    // オプション解析 (generate_tfmovr.cpp 準拠)
    ...
    for (size_t i = 0; i < results.size(); ++i) {
        ...
        size_t end_f = (i + 1 < results.size()) ? results[i + 1].first - 1 : 0;
